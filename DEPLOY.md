...
Полное руководство по выкатке Excel Tojiktelecom на боевой сервер. Способ один — **Docker**.
...
### 7. Включить HTTPS — см. раздел [«🔒 HTTPS»](#-https-важно-для-прода) ниже.
...
Добавить SSL-блок в `docker/nginx/default.conf`.
